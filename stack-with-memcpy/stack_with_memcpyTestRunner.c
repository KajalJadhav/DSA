...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_6_pushes_a_string_in_the_stack");
	setup();
		test_6_pushes_a_string_in_the_stack();
	tearDown();
	testEnded();
	...
	tearDown();
	testEnded();
	testStarted("test_8_pops_an_integer_element_from_the_stack");
	setup();
		test_8_pops_an_integer_element_from_the_stack();
	tearDown();
	testEnded();
	...
	tearDown();
	testEnded();
	testStarted("test_12_pops_string_from_the_stack");
	setup();
		test_12_pops_string_from_the_stack();
	tearDown();
	testEnded();
	testStarted("test_13_cannot_pop_an_element_from_the_empty_stack");
	setup();
		test_13_cannot_pop_an_element_from_the_empty_stack();
	tearDown();
	testEnded();
